...
const ErrorFaceIcon = ({size = 48, color = 'black'}) => {
    return (
        <View
            style={[
                {alignItems: 'center', justifyContent: 'center', width: size, height: size},
            ]}>
            <svg height="100%" strokeMiterlimit="10"
                 version="1.1"
                ...
                <g id="Untitled">
                    <path
                        ...
                        fill="none" opacity="1" stroke={color} strokeLinecap="butt" strokeLinejoin="miter"
                        strokeWidth="1"
                    />
                    <path
                        d="M11.6908 21.9998L11.6908 21.9998C9.16282 21.9998 7.11282 19.9508 7.11282 17.4218L7.11282 12.1218C7.11282 9.59383 9.16282 7.54483 11.6908 7.54483L11.6908 7.54483C14.2188 7.54483 16.2688 9.59383 16.2688 12.1218L16.2688 17.4218C16.2688 19.9508 14.2188 21.9998 11.6908 21.9998Z"
                        fill="none" opacity="1" stroke={color} strokeLinecap="butt" strokeLinejoin="miter"
                        strokeWidth="1"
                    />
                    <path
                    ...
                    <path
                        ...
                        fill={color} fillRule="evenodd" opacity="1" stroke="none"/>
                    <path
                    ...
                    <path
                        ...
                        fill="#b3b3b3" fillRule="evenodd" opacity="1" stroke="none"/>
                    <path
                        d="M9.76241 20.097C10.2794 19.661 10.9484 19.388 11.6894 19.388C12.4304 19.388 13.0994 19.661 13.6174 20.097"
                        fill="none" opacity="1" stroke={color} strokeLinecap="round" strokeLinejoin="miter"
                        strokeWidth="1"
                    />
                    <path
                        d="M9.76343 9.93332L10.3284 9.93332C10.5834 9.93332 10.8284 10.0353 11.0094 10.2153L11.0094 10.2153C11.3854 10.5923 11.9954 10.5923 12.3724 10.2153L12.3724 10.2153C12.5534 10.0353 12.7984 9.93332 13.0534 9.93332L13.6184 9.93332"
                        fill="none" opacity="1" stroke={color} strokeLinecap="round" strokeLinejoin="miter"
                        strokeWidth="1"
                    />
                    <path
                        d="M11.0908 16.7998L11.0908 17.3998C11.0908 17.7308 11.3598 17.9998 11.6908 17.9998L11.6908 17.9998C12.0218 17.9998 12.2908 17.7308 12.2908 17.3998L12.2908 16.7998"
                        fill="none" opacity="1" stroke={color} strokeLinecap="round" strokeLinejoin="miter"
                        strokeWidth="1"
                    />
                </g>
